...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:Filesystem_%build_mode%
...
lib.exe "Filesystem_%build_mode%.obj"

ECHO Done building Filesystem_%build_mode%.lib.
