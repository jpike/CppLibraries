...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:GraphicsTests_%build_mode%
...
SET COMPILATION_FILE="GraphicsTests.cpp"
SET LIBRARY_CODE_DIR="..\.."
SET LIBRARIES=user32.lib gdi32.lib

REM CREATE THE COMMAND LINE OPTIONS FOR THE FILES TO COMPILE/LINK.
SET INCLUDE_DIRS=/I %LIBRARY_CODE_DIR% /I ..\..\ThirdParty\Catch
...
REM RUN THE TESTS.
GraphicsTests_%build_mode%.exe

ECHO Done building/running GraphicsTest_%build_mode%s.exe.
