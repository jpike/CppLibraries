...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:Graphics_%build_mode%
...
SET INCLUDE_DIRS=/I %LIBRARY_PARENT_DIR% /I ..\ThirdParty
...
lib.exe "Graphics_%build_mode%.obj"

ECHO Done building Graphics_%build_mode%.lib.
