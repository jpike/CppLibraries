...
SET COMPILATION_FILE="..\..\Graphics.project"
SET MAIN_CODE_DIR="..\..\code"

REM CREATE THE COMMAND LINE OPTIONS FOR THE FILES TO COMPILE/LINK.
SET INCLUDE_DIRS=/I %MAIN_CODE_DIR% /I ..\..\..\Containers\code /I ..\..\..\Math\code
...
PUSHD "%build_directory%"
    ...
    lib.exe "Graphics.obj"

POPD

ECHO Done building Graphics.lib.
