...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:GraphicsTests
...
SET COMPILATION_FILE="..\..\testing\main.cpp"
SET MAIN_CODE_DIR="..\..\testing"
...
SET PROJECT_FILES_DIRS_AND_LIBS=%COMPILATION_FILE% %INCLUDE_DIRS% /link %LIBRARIES% /LIBPATH:..\..\..\Math\build\%build_mode%
...
ECHO Done building/running GraphicsTests.exe.
