...
namespace GRAPHICS::SHADING::LIGHTING
{
        ...
        const RenderingSettings& rendering_settings)
    {
        ...
        for (const Light& light : lights)
        {
            ...
            /// @todo   Cleanup.
            if ((LightType::AMBIENT == light.Type) && rendering_settings.Shading.Lighting.AmbientLightingEnabled)
            {
            ...
            else
            {
                ...
                /// @todo
                if ((ShadingType::MATERIAL == material.Shading) && rendering_settings.Shading.Lighting.DiffuseLightingEnabled)
                {
