...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:Windowing_%build_mode%
...
lib.exe "Windowing_%build_mode%.obj"

ECHO Done building Windowing_%build_mode%.lib.
