...
SET COMPILATION_FILE="..\..\Windowing.project"
SET MAIN_CODE_DIR="..\..\code"

REM CREATE THE COMMAND LINE OPTIONS FOR THE FILES TO COMPILE/LINK.
SET INCLUDE_DIRS=/I %MAIN_CODE_DIR% /I ..\..\..\Containers\code /I ..\..\..\Graphics\code
...
PUSHD "%build_directory%"
    ...
    lib.exe "Windowing.obj"

POPD

ECHO Done building Windowing.lib.
