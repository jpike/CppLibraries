...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:ContainersTests_%build_mode%
...
SET COMPILATION_FILE="ContainersTests.cpp"
SET LIBRARY_PARENT_DIR="..\.."

REM CREATE THE COMMAND LINE OPTIONS FOR THE FILES TO COMPILE/LINK.
SET INCLUDE_DIRS=/I %LIBRARY_PARENT_DIR% /I ..\..\ThirdParty\Catch
...
REM RUN THE TESTS.
ContainersTests_%build_mode%.exe

ECHO Done building/running ContainersTests.
