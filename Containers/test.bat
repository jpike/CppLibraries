...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:ContainersTests
...
SET INCLUDE_DIRS=/I %MAIN_CODE_DIR% /I ..\..\..\Containers\code /I ..\..\..\ThirdParty\Catch
...
ECHO Done building/running ContainersTests.exe.
