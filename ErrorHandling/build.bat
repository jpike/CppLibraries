...
SET COMMON_COMPILER_OPTIONS=/EHsc /WX /W4 /TP /std:c++latest /Fo:ErrorHandling_%build_mode%
...
SET INCLUDE_DIRS=/I %LIBRARY_PARENT_DIR%
...
lib.exe "ErrorHandling_%build_mode%.obj"

ECHO Done building ErrorHandling_%build_mode%.lib.
